# ---PARTICLE consts
MAX_POS = 3            # Maximum value of the position for both X and Y throughout the whole simulation
...
W = 0.01                 # Factor for the current velocity (> means exploitation, < means exploration)
